...
-- storing only the first would silently drop individual-market plans that
-- reference the same network file as employer groups. (Not currently populated —
-- reserved for plan-name attribution, see docs/known-gaps.md.)
...
-- rebuild the test schema via db/migrations/001_ga_coverage.sql (test.* is
